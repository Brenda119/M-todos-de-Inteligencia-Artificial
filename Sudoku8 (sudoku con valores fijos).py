...
#--------------------------------------------------------------------
def poblacion_i(a,b,mu,tablero):
    h3=[]
    h=tablero[:]
...
def valores_fijos(tablero):
    ...
    for i in range(len(tab)):
        ...
        for j in range(len(tab)):
            if tab[i][j]!=0:
                val.append(j) #Guardar las posiciones de los números fijos
                #val.append(tab[i][j]) #Guardar los valores de los números fijos
                val1=val[:]
        valores_f.append(val1)
#--------------------------------------------------------------------
...
def mutacion(sudoku_o):
    ...
    if m==0:
        ...
        for i in range(len(val_f)):
            ...
            if val1 == columna1:
                ...
                while bandera>0:
                    columna1=rd.randint(0,b-1)
                    for j in range(len(val_f)):
                        val2 = val_f[j]
                        if val2 == columna1:
                            bandera+=1
                        if j == len(val_f)-1 and bandera==1:
                            bandera=0
                    if bandera>1:
                        bandera=1
            ...
            if val1 == columna2:
                ...
                while bandera1>0:
                    ...
                    for j in range(len(val_f)):
                        ...
                        if val2 == columna2:
                            bandera1+=1
                        if j == len(val_f)-1 and bandera1==1:
                            bandera1=0
                    if bandera1>1:
                        bandera1=1
    ...
    if m==1:
        ...
        #Mutación para las columnas repetidas
        if d!=0:
            for k in range (3):
                #print("REP_COLUMNAS")
                #print(rep_columnas)
...
tablero_original=np.loadtxt('sudoku_2.txt', dtype=int)
tablero_original=tablero_original.tolist()

sudoku_original = c.deepcopy(tablero_original)
sudoku_original = poblacion_i(a,b,mu,sudoku_original)

valores_fijos(tablero_original)
