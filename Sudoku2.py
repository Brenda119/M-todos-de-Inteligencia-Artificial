...
def repeticion_columnas():
    ...
    return f3
#--------------------------------------------------------------------
def mutacion(repeticiones,X,b):
    mut=X[:]
    posicion_fila = rd.randint(0,len(repeticiones))
    posicion_fila = repeticiones[posicion_fila]
    print("Fila")
    print(posicion_fila)
    posicion_columna1=contador-1
    posicion_columna2=rd.randint(0,b-1)
    if posicion_columna2==posicion_columna1:
        while posicion_columna2==posicion_columna1:
            posicion_columna2=rd.randint(0,b-1)
    print("Columnas")
    print(posicion_columna1,posicion_columna2)
    
    num1=mut[posicion_fila][posicion_columna1]
    num2=mut[posicion_fila][posicion_columna2]
    
    mut[posicion_fila][posicion_columna1]=num2
    mut[posicion_fila][posicion_columna2]=num1
...
rep_columnas=repeticion_columnas()
#print(rep_columnas)
#print(n_repeticiones)
print("----------------Sudoku mutado----------------")
X=mutacion(rep_columnas,X,b)
print('')
for i in range(0,len(X)):
    print(X[i])
    
    #grafica numero de iteracion contra fitness
